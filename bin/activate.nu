...
export-env {
    ...
    let virtual_env = '/Users/sjcha/Documents/6. 개인작업 관리(smilechacha)/@모두의연구소/@모두의연구소 - 04 - GC케어&유비케어/202511_gccare/gccare-langchain-rag-ai'
    let bin = 'bin'
